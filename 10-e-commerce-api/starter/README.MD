...
- [x] if everything is correct, attach cookie and send back the same response as
      in register
...
- [x] export (createProduct, getAllProducts, getSingleProduct, updateProduct,
      deleteProduct, uploadImage) functions
...
- [x] export (createReview, getAllReviews, getSingleReview, updateReview,
      deleteReview) functions
- [x] res.send('function name')
...
- [x] export (getAllOrders, getSingleOrder, getCurrentUserOrders, createOrder,
      updateOrder) functions
- [x] res.send('function name')
